  ...
  return (
    <div className="ml-[700px] mt-[0px] flex h-[850px]">
      <div className="flex flex-col items-center justify-center px-4 text-center">
        <img
          src="/images/midy-logo.png"
          alt="Logo"
          className="mb-4 w-24 dark:hidden"
        />
        <img
          src="/images/global/logo-mini.png"
          alt="Logo"
          className="mb-4 hidden w-24 dark:block"
        />
        ...
        <input
          ...
          className="mt-6 w-full max-w-md rounded border border-gray-300 px-4 py-2"
        />
      </div>
    </div>
  );
